...
Portfolio and blog of Awal Ariansyah. The site is a spreadsheet.

HTML, CSS, and JavaScript modules. No framework and no bundler. The browser runs the source files as they are.
